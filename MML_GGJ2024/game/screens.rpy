...
screen main_menu():
    ...
    imagemap: 
        ...
        hotspot(0, 430, 604, 540) action Start()
        hotspot(0, 563, 604, 675) action ShowMenu("load")
        hotspot(0, 699, 604, 810) action ShowMenu("preferences")
        hotspot(0, 835, 604, 945) action Quit(confirm=True)
